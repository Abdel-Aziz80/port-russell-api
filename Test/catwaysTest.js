...
describe('Catway Controller - getAll', () => {
  ...
  it('should return 500 status with error when Catway.find fails', async () => {
...
describe('Catway Controller - getById', () => {
    ...
    it('should return 500 status with error when Catway.findById fails', async () => {
      req.params.id = new mongoose.Types.ObjectId().toString();
      const error = new Error('Database error');
...
describe('Catway Controller - add', () => {  
    let req, res, next;
    ...
    it('should create a new catway and redirect on success', async () => {
      req.body = {
        catwayNumber: 1,
        type: 'long',
        catwayState: 'good'
    ...
    it('should accept valid input with optional catwayState', async () => {
        req.body = {
          catwayNumber: 2,
          type: 'short'
        };
...
describe('Catway Controller - update', () => {
  let req, res, next;
...
describe('Catway Controller - delete', function() {
    ...
    it('should delete a catway and return 204 status on success', async () => {
    ...
    it('should return 204 status even if no catway was found to delete', async () => {
